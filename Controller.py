...
class Controller:
    ...
    def click_btn_new(self):
        ...
        self.view.char_input.focus()  # Active input fields
        self.gametime.reset()
        self.gametime.start()
    ...
    def click_btn_cancel(self):
        ...
        self.view.char_input.delete(0, 'end')  # kustutab sisestuskasti
        self.view.change_image(len(self.model.image_files) - 1)

    def click_btn_send(self):
        self.model.get_user_input(self.view.userinput.get().strip())  # Strip tühikud alguses ja lõpus
        self.view.lbl_result.configure(text=self.model.user_word)
